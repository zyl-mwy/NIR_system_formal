...
template <> constexpr inline auto SerialCommunicator::qt_create_metaobjectdata<qt_meta_tag_ZN18SerialCommunicatorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'setExposureTimeUs'
        QtMocHelpers::MethodData<bool(double, const QString &)>(10, 2, QMC::AccessPublic, QMetaType::Bool, {{
            { QMetaType::Double, 11 }, { QMetaType::QString, 7 },
        }}),
        // Method 'setExposureTimeUs'
        QtMocHelpers::MethodData<bool(double)>(10, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Bool, {{
            { QMetaType::Double, 11 },
        }}),
        // Method 'setReadoutTimeUs'
        QtMocHelpers::MethodData<bool(double, const QString &)>(12, 2, QMC::AccessPublic, QMetaType::Bool, {{
            { QMetaType::Double, 13 }, { QMetaType::QString, 7 },
        }}),
        // Method 'setReadoutTimeUs'
        QtMocHelpers::MethodData<bool(double)>(12, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Bool, {{
            { QMetaType::Double, 13 },
        }}),
    };
...
void SerialCommunicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: { bool _r = _t->toggleCommand();
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 8: { bool _r = _t->setExposureTimeUs((*reinterpret_cast<std::add_pointer_t<double>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 9: { bool _r = _t->setExposureTimeUs((*reinterpret_cast<std::add_pointer_t<double>>(_a[1])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 10: { bool _r = _t->setReadoutTimeUs((*reinterpret_cast<std::add_pointer_t<double>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 11: { bool _r = _t->setReadoutTimeUs((*reinterpret_cast<std::add_pointer_t<double>>(_a[1])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }

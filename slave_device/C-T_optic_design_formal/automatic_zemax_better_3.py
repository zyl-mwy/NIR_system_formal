...
class LDEBuilder:
    ...
    def build_cross_ct_like_base0(self, system: Any, ZOSAPI: Any, p: Dict[str, Any], opts: Dict[str, Any], basicStructure: list) -> None:
        ...
        if len(other_settings["need_focus"]) != 0:
            s0_2 = lde.GetSurfaceAt(basicStructure.index("AC127-025-C_0"))
            ...
            s0_3 = lde.GetSurfaceAt(basicStructure.index("AC127-025-C_1"))
            ...
            s0_4 = lde.GetSurfaceAt(basicStructure.index("AC127-025-C_2"))
...
if __name__ == "__main__":
    ...
    other_settings = {
        ...
        "need_silt": True,
        "need_parallel_light": 4,
        "need_focus": [
            {"comment": "AC127-025-C_0", "f_mm": 12.0, "d_mm": 4.7, "material": "N-LAK22", "surface":"THORC", "SemiDiameter": 6.35},
            {"comment": "AC127-025-C_1", "f_mm": -12.940, "d_mm": 1.5, "material": "N-SF6HT", "surface":"", "SemiDiameter": 6.35},

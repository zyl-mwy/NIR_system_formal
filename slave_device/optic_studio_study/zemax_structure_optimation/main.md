...
#### 半高宽（FWHM）的计算
* 计算光谱分辨率主要考虑入射狭缝、光学系统剩余像差、光学系统衍射极限这三个因素
* 入射狭缝主要是狭缝宽决定，光学系统剩余像差主要是Zemax中rms决定，光学系统衍射极限由$1.22*\lambda*F\#$决定。所以某波长的近似半高宽（FWHM）：
$$FWHM=silt\_width + rms -y @ wavelength + 1.22 * \lambda * F\#$$
* 其中$rms -y @ wavelength$来源zemax中 分析——RMS——RMS vs 波长
* 分析——RMS——RMS vs 波长——设置——光线密度：4，波长密度：5，数据：Y光斑
* 最后某波长的分辨率$=线色散*FWHM$